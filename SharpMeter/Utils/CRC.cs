...
namespace SharpMeter.Utils
{
        ...
        private static readonly ushort[] RevCCITT =
    {
        ...
        {
            var iBytesRead = bybuf.Length;

            ushort crca = 0xFFFF;

            for (var iIndex = 0; iIndex < iBytesRead; iIndex++)
            {
        ...
        ///   <br />
        /// </returns>
        public static ushort CalcCRC(byte[] buffer, ushort index, ushort count)
        {
            ushort usCRC = 0;
        ...
        /// <summary>Calculates the CRC16.</summary>
        /// <param name="octet">The octet.</param>
        /// <param name="crc">The CRC.</param>
        /// <returns>
        ///   <br />
        /// </returns>
        private static ushort CalcCRC16(byte octet, ushort crc)
        {
            int i;
        ...
        internal static UInt16 CountFCS16(byte[] buff, int index, int count)
        {
            ...
            {
                FCS16 = (int)(((FCS16 >> 8) ^ RevCCITT[(FCS16 ^ buff[pos]) & 0xFF]) & 0xFFFF);
            }
            FCS16 = ~FCS16;
        ...
        #endregion Calculate CRC Methods
    }
}